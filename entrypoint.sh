...
export APOLLO_USER APOLLO_PASS
echo -e "export APOLLO_USER=${APOLLO_USER} APOLLO_PASS=${APOLLO_PASS}" >> /etc/profile
echo -e "export APOLLO_USER=${APOLLO_USER} APOLLO_PASS=${APOLLO_PASS}" >> /etc/bash.bashrc
